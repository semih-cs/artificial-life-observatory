...
describe('model identity and layout', () => {
  it('(1–4) 0A.1.0 / 0A.2.0 / 0A.3.0 stay feed-forward (6/6/10 → 8 → 4); 0A.4.0 is 10 → 8 recurrent → 4', () => {
    expect(SUPPORTED_MODEL_VERSIONS).toEqual(['0A.1.0', '0A.2.0', '0A.3.0', '0A.4.0']);
    const expected = { '0A.1.0': [6, false], '0A.2.0': [6, false], '0A.3.0': [10, false], '0A.4.0': [10, true] } as const;
